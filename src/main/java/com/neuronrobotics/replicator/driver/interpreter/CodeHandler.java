...
public abstract class CodeHandler {
	...
	/**
	 *
	 * Execute the action associated with this handler. this <em>is permitted</em>
	 * to modify the values stored in line; prev should be considered immutable.
	 *
	 * @param prev
	 *            The register values for the previous line of G code. Contains such
	 *            things as the last set position, for interpolation schemes.
	 * @param line
	 *            The current set of register values for this line of G code.
	 * @throws Exception
	 *             the exception
	 */
