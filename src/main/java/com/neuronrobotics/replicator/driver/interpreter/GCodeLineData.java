...
/**
 * Encapsulates the register information in a line of G code, stored as
...
public class GCodeLineData {
	...
	/**
	 * Copies a GCodeLineData object. By default, registers are copied between every
	 * line, such that a Y1.5 setting is kept if Y is not mentioned.
	 *
	 * @param toCopy
	 *            Usually the data for the previous line of G code.
	 */
	 ...
	 *
	 * @param c
	 *            the register letter. May be upper or lower case.
	 * @param val
	 *            the new value.
	 */
	 ...
	 *
	 * @param c
	 *            the register letter. <em>must</em> be upper case.
