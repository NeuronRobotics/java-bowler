 ...
 * Presently used for absolute positioning and programming in mm, because those
 * are the internal representations.
 *
 */
public class EmptyCodeHandler extends CodeHandler {
	 ...
	 *
	 * @see
	 * com.neuronrobotics.replicator.driver.interpreter.CodeHandler#execute(com.
	 * neuronrobotics.replicator.driver.interpreter.GCodeLineData,
	 * com.neuronrobotics.replicator.driver.interpreter.GCodeLineData)
	 */
