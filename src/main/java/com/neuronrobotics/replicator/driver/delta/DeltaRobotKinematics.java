...
public class DeltaRobotKinematics {
	...
	public double[] delta_calcInverse(TransformNR input) {
		...
		theta2 = delta_calcAngleYZ(x0 * cos120 + y0 * sin120, y0 * cos120 - x0 * sin120, z0); // rotate coords to +120
																								// deg
		theta3 = delta_calcAngleYZ(x0 * cos120 - y0 * sin120, y0 * cos120 + x0 * sin120, z0); // rotate coords to -120
																								// deg
