...
/**
 * This class is a wrapper for the DyIO PPM signal reader. This manages taking
 * Channel 23 and using it to read values from the VEX rc controller (others
...
public class PPMReaderChannel extends DyIOAbstractPeripheral implements IChannelEventListener {
	 ...
	 * the PPM channel, and values corospond to the DyIO output channel
	 *
	 * @param links
	 *            an array of channel numbers corosponding to the PPM channel to do
	 ...
	 *
	 * @return an array of integers corosponding to the cross linking for the DyIO
	 *         outputs
	 */
