...
public abstract class AbstractPidNamespaceImp implements IExtendedPIDControl {
	...
	/**
	 * Gets the number of PID channels available to the system. It is determined by
	 * how many PID channels the device reports back after a calling
	 * GetAllPIDPosition();
	 *
