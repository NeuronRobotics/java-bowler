...
public class LegacyPidNamespaceImp extends AbstractPidNamespaceImp {
	...
	public boolean SetPIDSetPoint(int group, float setpoint, double seconds) {
		...
		Log.info(
				"Setting PID position group=" + group + ", setpoint=" + setpoint + " ticks, time=" + seconds + " sec.");
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#illAllPidGroups
	 */
	@Override
