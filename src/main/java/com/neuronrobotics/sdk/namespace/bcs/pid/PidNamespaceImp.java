...
public class PidNamespaceImp extends AbstractPidNamespaceImp implements IExtendedPIDControl {
	...
	public boolean ResetPIDChannel(int group, float valueToSetCurrentTo) throws DeviceConnectionException {
		...
		send(BowlerMethod.POST, "rpid", args);
		return true;
	}
	...
	public boolean ConfigurePIDController(PIDConfiguration config) {
		send(BowlerMethod.CRITICAL, "cpid", config.getArgs());
		return true;
	}
	...
	public PIDConfiguration getPIDConfiguration(int group) {
		...
		return new PIDConfiguration(send(BowlerMethod.GET, "cpid", new Object[]{group}));
	}
	...
	public boolean ConfigurePDVelovityController(PDVelocityConfiguration config) {
		send(BowlerMethod.CRITICAL, "cpdv", config.getArgs());
		return true;
	}
	...
	public PDVelocityConfiguration getPDVelocityConfiguration(int group) {
		Object[] args = send(BowlerMethod.GET, "cpdv", new Object[]{group});
	...
	public int getPIDChannelCount() {
		if (channelCount == null) {
			Object[] args = send(BowlerMethod.GET, "gpdc", new Object[]{});
	...
	public boolean SetPIDSetPoint(int group, float setpoint, double seconds) {
		send(BowlerMethod.POST, "_pid", new Object[]{group, setpoint, (int) (seconds * 1000)});
		return true;
	}
	...
	public boolean SetAllPIDSetPoint(float[] setpoints, double seconds) {
		send(BowlerMethod.POST, "apid", new Object[]{new Integer((int) (seconds * 1000)), setpoints});
		return true;
	}
	...
	public float GetPIDPosition(int group) {
		Object[] args = send(BowlerMethod.GET, "_pid", new Object[]{group});
	...
	public float[] GetAllPIDPosition() {
		Object[] args = send(BowlerMethod.GET, "apid", new Object[]{});
	...
	public boolean SetPDVelocity(int group, int unitsPerSecond, double seconds) throws PIDCommandException {
		send(BowlerMethod.POST, "_vpd", new Object[]{group, unitsPerSecond, (int) (seconds * 1000)});
		return true;
	}
	...
	public boolean killAllPidGroups() {
		send(BowlerMethod.CRITICAL, "kpid", new Object[]{});
		return true;
	}
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.neuronrobotics.sdk.namespace.bcs.pid.AbstractPidNamespaceImp#
	 * onAsyncResponse(com.neuronrobotics.sdk.common.BowlerDatagram)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.neuronrobotics.sdk.namespace.bcs.pid.IExtendedPIDControl#
	 * runOutputHysteresisCalibration(int)
	 */
	@Override
	public boolean runOutputHysteresisCalibration(int group) {
		send(BowlerMethod.POST, "hist", new Object[]{group});
		return true;
	}
