...
public class PidDeviceServerNamespace extends BowlerAbstractDeviceServerNamespace implements IPidControlNamespace {
	...
	public PidDeviceServerNamespace(MACAddress addr, IPidControlNamespace device) {
		...
		this.device = device;
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "apid", BowlerMethod.GET,
				new BowlerDataType[]{}, BowlerMethod.POST, new BowlerDataType[]{BowlerDataType.I32STR},
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "_pid", BowlerMethod.GET,
				new BowlerDataType[]{BowlerDataType.I08}, BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I32}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
						// anythign
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "cpid", BowlerMethod.GET,
				new BowlerDataType[]{BowlerDataType.I08}, BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.I08,
						BowlerDataType.FIXED100, BowlerDataType.FIXED100, BowlerDataType.FIXED100, BowlerDataType.I32,
						BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.FIXED1k, BowlerDataType.FIXED1k,
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "cpdv", BowlerMethod.GET,
				new BowlerDataType[]{BowlerDataType.I08}, BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.FIXED100, BowlerDataType.FIXED100},
				new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "gpdc", BowlerMethod.GET,
				new BowlerDataType[]{}, BowlerMethod.POST, new BowlerDataType[]{BowlerDataType.I32},
				new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "apid", BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I32, BowlerDataType.I32STR}, BowlerMethod.STATUS,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "_pid", BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I32, BowlerDataType.I32}, BowlerMethod.STATUS,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
						SetPIDSetPoint((Integer) data[0], (Integer) data[1], (Integer) data[2]);

						return new Object[]{data[0], new Integer(5)};
					}
				}));// Name
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "_vpd", BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I32, BowlerDataType.I32}, BowlerMethod.STATUS,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
						try {
							SetPDVelocity((Integer) data[0], (Integer) data[1], (Integer) data[2]);
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "rpid", BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I32}, BowlerMethod.STATUS,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "kpid", BowlerMethod.CRITICAL,
				new BowlerDataType[]{}, BowlerMethod.STATUS,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
						killAllPidGroups();
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "cpid", BowlerMethod.CRITICAL,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.I08,
						BowlerDataType.FIXED100, BowlerDataType.FIXED100, BowlerDataType.FIXED100, BowlerDataType.I32,
						BowlerDataType.I08, BowlerDataType.I08, BowlerDataType.FIXED1k, BowlerDataType.FIXED1k,
						BowlerDataType.FIXED1k},
				BowlerMethod.STATUS, new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08},
				new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
		...
		rpc.add(new RpcEncapsulation(getNamespaceIndex(), getNamespace(), "cpdv", BowlerMethod.CRITICAL,
				new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.FIXED100, BowlerDataType.FIXED100},
				BowlerMethod.STATUS, new BowlerDataType[]{BowlerDataType.I08, BowlerDataType.I08},
				new IBowlerCommandProcessor() {
					@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#ResetPIDChannel
	 * (int, int)
	 */
	@Override
	 ...
	 * ConfigurePIDController(com.neuronrobotics.sdk.pid.PIDConfiguration)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#SetPIDSetPoint(
	 * int, int, double)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#GetPIDPosition(
	 * int)
	 */
	@Override
	 ...
	 *
	 * @see com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#
	 * addPIDEventListener(com.neuronrobotics.sdk.pid.IPIDEventListener)
	 */
	@Override
	 ...
	 *
	 * @see com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#
	 * removePIDEventListener(com.neuronrobotics.sdk.pid.IPIDEventListener)
	 */
	@Override
	 ...
	 *
	 * @see com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#
	 * SetPIDInterpolatedVelocity(int, int, double)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#SetPDVelocity(
	 * int, int, double)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#getPIDChannel(
	 * int)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.namespace.bcs.pid.IPidControlNamespace#isAvailable()
	 */
	@Override
