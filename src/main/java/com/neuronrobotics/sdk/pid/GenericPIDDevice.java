...
/**
 * This class is a generic implementation of the PID system. This can be used as
 * a template, superclass or internal object class for use with and device that
 * implements the IPIDControl interface.
 *
 * @author hephaestus
 *
 */
public class GenericPIDDevice extends BowlerAbstractDevice implements IExtendedPIDControl, IFlushable {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.neuronrobotics.sdk.common.BowlerAbstractDevice#setConnection(com.
