...
public class ConfigurePIDCommand extends BowlerAbstractCommand {
	 ...
	 *            the h stop
	 */
	public ConfigurePIDCommand(char group, boolean enabled, boolean inverted, boolean async, double KP, double KI,
			double KD, double latchValue, boolean use, boolean stop, double up, double low, double hStop) {
