...
public class BcsCoreNamespaceImp extends BowlerAbstractDeviceServerNamespace {
	...
	public BcsCoreNamespaceImp(final BowlerAbstractServer s, MACAddress mac) {
		super(mac, "bcs.core.*;;");
		this.server = s;
		rpc.add(new RpcEncapsulation(0, getNamespace(), "_png", BowlerMethod.GET, new BowlerDataType[]{},
				BowlerMethod.POST, new BowlerDataType[]{}, new IBowlerCommandProcessor() {
					@Override
		...
		rpc.add(new RpcEncapsulation(0, getNamespace(), "_nms", BowlerMethod.GET,
				new BowlerDataType[]{BowlerDataType.I08}, BowlerMethod.POST,
				new BowlerDataType[]{BowlerDataType.ASCII, BowlerDataType.I08}, new IBowlerCommandProcessor() {
					@Override
					public Object[] process(Object[] data) {
