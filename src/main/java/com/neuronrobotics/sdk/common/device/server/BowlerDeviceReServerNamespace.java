...
public class BowlerDeviceReServerNamespace extends BowlerAbstractDeviceServerNamespace {
	...
	public BowlerDeviceReServerNamespace(BowlerAbstractConnection device, BowlerAbstractServer server, boolean useAsync,
			int namespaceIndex, String namespaceString, GenericDevice gen) {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.neuronrobotics.sdk.common.device.server.
	 * BowlerAbstractDeviceServerNamespace#process(com.neuronrobotics.sdk.common.
	 * BowlerDatagram)
	 */
	@Override
