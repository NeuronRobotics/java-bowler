...
/**
 * This class encapsulates the generation of a Bowler RPC. Each command should
 * represent a unique RPC.
 *
 * @author rbreznak
 *
 */
public abstract class BowlerAbstractCommand implements ISendable {
	 ...
	 * Each instance of a BAC should determine the correct method for generating
	 * this data.
	 *
	...
	/**
	 * Set the operation code string. To conform to the Bowler standard, the string
	 * should be 4 characters.
	 *
	 * @param opCode
	 *            the RPC operation code to be implemented.
	 */
			...
			switch (zone) {
					...
					switch (section) {
						default :
							throw new InvalidResponseException(
									"Unknow error in the communications stack. (" + zone + " " + section + ")" + data);
						case 0x7f :
				...
				case 85 :
					switch (section) {
						default :
							throw new InvalidResponseException(
									"Unknown co-processor error. (" + zone + " " + section + ")");
						case 1 :
						case 2 :
				...
				case 1 :
					switch (section) {
						default :
							throw new InvalidResponseException(
									"Unknow error in the GET parser. (" + zone + " " + section + ")");
						case 0 :
							throw new InvalidResponseException(
				...
				case 2 :
					switch (section) {
						default :
							throw new InvalidResponseException(
									"Unknow error in the POST parser. (" + zone + " " + section + ")");
						case 0 :
							throw new InvalidResponseException("Failed to properly set the value to the channel.");
						case 1 :
							throw new InvalidResponseException(
									"Failed to properly set the mode / the given mode type is unknown.");
						case 2 :
				...
				case 6 :
					switch (section) {
						default :
							throw new InvalidResponseException(
									"Unknow error in the CRITICAL parser. (" + zone + " " + section + ")");
						case 0 :
						...
						case 3 :
							throw new InvalidResponseException(
									"Invalid name string, either too short or too long " + data);
					}
			}
		}
