...
public class RpcEncapsulation {
	 ...
	 *            the namespace index
	 * @param namespace
	 *            The corosponding Namespace
	 * @param rpc
	 *            The 4 byte RPC code
	 * @param downStreamMethod
	 *            The method for sending messages
	 * @param downstreamArguments
	 *            The array of data types for a downstream message
	 * @param upStreamMethod
	 *            The return method type
	 * @param upstreamArguments
	 *            THe return method arguments
	 */
	public RpcEncapsulation(int namespaceIndex, String namespace, String rpc, BowlerMethod downStreamMethod,
			BowlerDataType[] downstreamArguments, BowlerMethod upStreamMethod, BowlerDataType[] upstreamArguments) {
		this(namespaceIndex, namespace, rpc, downStreamMethod, downstreamArguments, upStreamMethod, upstreamArguments,
				null);
	}
	 ...
	 *            the upstream arguments
	 */
	public void setArguments(BowlerMethod downStreamMethod, BowlerDataType[] downstreamArguments,
	 ...
	 * Gets the command.
	 *
	 * @param doswnstreamData
	 *            the doswnstream data
	 * @return the command
	 */
			...
			try {
				switch (arguments[i]) {
					...
					case I08 :
						...
						break;
					case BOOL :
						command.getCallingDataStorage()
								.add(Boolean.parseBoolean((doswnstreamData[i].toString())) ? 1 : 0);
						break;
					case I16 :
