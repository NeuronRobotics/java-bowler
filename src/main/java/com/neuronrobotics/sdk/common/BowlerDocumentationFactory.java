...
public class BowlerDocumentationFactory {
	...
	public static URI getDocumentationURL(Object input) {
		...
		if (input instanceof DigitalInputChannel) {
			...
			try {
				return new URI(basURL + "Digital-Input-Example-Simple/");
			...
			try {
				return new URI(basURL + "Analog-Input-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
			...
			try {
				return new URI(basURL + "Counter-Input-Quadrature-Encoder-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
			...
			try {
				return new URI(basURL + "Digital-Output-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
			...
			try {
				return new URI(basURL + "PPM-RC-Signal-Reader-Channle-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
			...
			try {
				return new URI(basURL + "SPI-Channel-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
			...
			try {
				return new URI(basURL + "USART-Channel-Example/");
			} catch (URISyntaxException e) {
				Log.error(e.getMessage());
			}
		}
