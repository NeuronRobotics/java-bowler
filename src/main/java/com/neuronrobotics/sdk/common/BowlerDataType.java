...
public enum BowlerDataType implements ISendable {
	...
	/**
	 * stream of 8 bit unsigned ints, first byte is unsigned char to indicate number
	 * of data values in the stream.
	 */
	STR(37),

	/**
	 * stream of 32 bit signed ints, first byte is unsigned char to indicate number
	 * of data values in the stream.
	 */
	I32STR(38),
	...
	/**
	 * stream of floats, first byte is unsigned char to indicate number of data
