...
/**
 * AbstractDevices are used to model devices that are connected to the Bowler
 * network. AbstractDevice implementations should encapsulate command generation
 * and provide higher-level actions to users.
 *
 * @author rbreznak
 *
 */
public abstract class BowlerAbstractDevice extends TimeKeeper implements IBowlerDatagramListener {
	...
	public void addConnectionEventListener(final IDeviceConnectionEventListener l) {
		...
		// com.neuronrobotics.sdk.common.Log.error(getScriptingName()+" Adding listener
		// "+l.getClass());
	...
	/**
	 * This method tells the connection object to start and connects the up and down
	 * streams pipes. Once this method is called and returns without exception, the
	 * device is ready to communicate with
	 *
	...
	/**
	 * Set the MAC Address of the device. Every device should have a unique MAC
	 * address.
	 *
	 * @param address
	 *            the new address
	 ...
	 *             the invalid response exception
	 */
	public BowlerDatagram send(BowlerAbstractCommand command, int retry)
			throws NoConnectionAvailableException, InvalidResponseException {
	 ...
	 */
	public Object[] send(String namespace, BowlerMethod method, String rpcString, Object[] arguments, int retry)
			throws DeviceConnectionException {
	 ...
	 *             If the desired RPC's are not available then this will be thrown
	 */
	public Object[] send(String namespace, BowlerMethod method, String rpcString, Object[] arguments)
			throws DeviceConnectionException {
