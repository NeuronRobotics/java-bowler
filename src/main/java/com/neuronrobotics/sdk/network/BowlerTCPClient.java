...
public class BowlerTCPClient extends BowlerAbstractConnection {
	...
	/**
	 * This will broadcast out 1 packet on UDP socket 1865. It will wait for devices
	 * to respond and makes a list of the available TCP sockets
	 *
