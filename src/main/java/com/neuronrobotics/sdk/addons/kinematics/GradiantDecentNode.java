...
public class GradiantDecentNode {
	 ...
	 *            the l
	 */
	public GradiantDecentNode(DHChain chain, int index, double[] jointSpaceVector, TransformNR cartesianSpace, double u,
			double l) {
		this.chain = chain;
		this.offset = 0;
		this.setIndex(index);
	...
	public void jitter() {
		...
		com.neuronrobotics.sdk.common.Log
				.error("Jittering Link #" + getIndex() + " jitter:" + jitter + " current offset:" + offset);
		offset += jitter;
		jointSpaceVector[getIndex()] = myStart + offset;
	}
