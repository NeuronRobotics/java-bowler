...
/**
 * The listener interface for receiving ILink events. The class that is
 * interested in processing a ILink event implements this interface, and the
 * object created with that class is registered with a component using the
 * component's addILinkListener method. When the ILink event occurs, that
