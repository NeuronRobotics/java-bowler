...
/**
 * This is a state object for the IMU any function that returns null has no new
 * data available.
 *
 * @author hephaestus
 *
...
public class IMUUpdate {
	...
	/**
	 * Values represent current state of accelerations Null values means there is no
	 * update for this value
	 *
	 * @param xAcceleration
	 *            (meters / second^2)
	 * @param yAcceleration
	 ...
	 * @param zAcceleration
	 *            (meters / second^2)
	 * @param rotxAcceleration
	 *            (radian / second^2)
	 * @param rotyAcceleration
	 *            (radian / second^2)
	 * @param rotzAcceleration
	 *            (radian / second^2)
	 */
	public IMUUpdate(Double xAcceleration, Double yAcceleration, Double zAcceleration, Double rotxAcceleration,
			Double rotyAcceleration, Double rotzAcceleration, long timestamp) {
	...
	@Deprecated
	public IMUUpdate(Double xAcceleration, Double yAcceleration, Double zAcceleration, Double rotxAcceleration,
			Double rotyAcceleration, Double rotzAcceleration) {
		this.xAcceleration = xAcceleration;
		this.yAcceleration = yAcceleration;
		this.zAcceleration = zAcceleration;
		this.rotxAcceleration = rotxAcceleration;
		...
		if (notice) {
			notice = false;
			new RuntimeException("This constructor is depricated, please provide a timestamp")
