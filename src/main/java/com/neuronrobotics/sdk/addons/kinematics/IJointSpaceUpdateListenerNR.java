...
public interface IJointSpaceUpdateListenerNR {
	...
	/**
	 * The JointSpace update event This is called when the kinematics model has a
	 * new set of pose data.
	 *
	 * @param source
	 *            The AbstractKinematics object that the update was called from
	 * @param joints
	 *            the current joint space values mm,radians
	 */
	...
	/**
	 * The JointSpace limit This is called when the kinematics model has a new set
	 * of pose data.
	 *
	 * @param source
	 *            The AbstractKinematics object that the update was called from
