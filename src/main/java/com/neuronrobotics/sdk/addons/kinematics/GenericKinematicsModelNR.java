...
public class GenericKinematicsModelNR extends AbstractKinematicsNR {
	...
	// super(XmlFactory.getDefaultConfigurationStream("GenericKinematics.xml"),new
	// LinkFactory( dev));
	// }
	...
	public GenericKinematicsModelNR() {
		super(XmlFactory.getDefaultConfigurationStream("GenericKinematics.xml"),
				new LinkFactory(new VirtualGenericPIDDevice(1000000, "GenericKinematicsDevice")));
	}
