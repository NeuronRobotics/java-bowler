...
public class WalkingDriveEngine implements IDriveEngine {
	 ...
	 * (non-Javadoc)
	 *
	 * @see com.neuronrobotics.sdk.addons.kinematics.IDriveEngine#DriveArc(com.
	 * neuronrobotics.sdk.addons.kinematics.MobileBase,
	...
	public void DriveArc(MobileBase source, TransformNR newPose, double seconds) {
		...
		double rotz = newPose.getRotation().getRotationAzimuthRadians()
				+ global.getRotation().getRotationAzimuthRadians();
		...
		for (int i = 0; i < numlegs; i++) {
			if (!legs.get(i).checkTaskSpaceTransform(feetLocations[i])) {
				// new leg position is not reachable, reverse course and walk up the line to a
				// better location
				do {
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.addons.kinematics.IDriveEngine#DriveVelocityStraight(
	 * com.neuronrobotics.sdk.addons.kinematics.MobileBase, double)
	 */
	@Override
	 ...
	 *
	 * @see
	 * com.neuronrobotics.sdk.addons.kinematics.IDriveEngine#DriveVelocityArc(com.
	 * neuronrobotics.sdk.addons.kinematics.MobileBase, double, double)
	 */
	@Override
