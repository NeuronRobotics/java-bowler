...
public class CreateArm {
	 ...
	 *
	 * @param links
	 *            this is an array of servo channel links. 0th element is shoulder
	 *            1th element is elbow 2th element is is wrist 3th element is the
	 *            gripper
	 */
	...
	/**
	 * This takes angles in degrees and converts them to servo positions; Note: All
	 * zeros would be the arm completely horizontal, all links pointing out.
	 *
	 * @param shoulder
	 *            the shoulder
	 * @param elbow
	 ...
	 * Gets the angles.
	 *
	 * @return an array of angles in degrees. This should correspond to pose of the
	 *         arm.
	 */
	...
	public double[] getCartesianPose() {
		...
		pose[0] = (l1 * cos(ToRadians(angles[0])) + l2 * cos(ToRadians(angles[0]) + ToRadians(angles[1]))
				+ (l3 * cos(ToRadians(GetOrientation()))));
		pose[1] = (l1 * sin(ToRadians(angles[0])) + l2 * sin(ToRadians(angles[0]) + ToRadians(angles[1]))
				+ (l3 * sin(ToRadians(GetOrientation()))));
