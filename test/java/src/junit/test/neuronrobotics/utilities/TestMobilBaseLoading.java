...
public class TestMobilBaseLoading {
	...
	public void test() throws IOException {
		...
		// .setVitamin(new VitaminLocation("test1", "hobbyServo", "mg92b", new
		// TransformNR(0, 1, 4)));
		// base.setVitamin(new VitaminLocation("test1", "hobbyServo", "mg92b", new
		// TransformNR(0, 1, 4)));
		// base.setVitamin(new VitaminLocation("test2", "hobbyServo", "mg92b", new
		// TransformNR(0, 1, 4)));
		// base.setVitamin(new VitaminLocation("test1", "hobbyServo", "mg92b", new
		// TransformNR(0, 1, 4)));
		...
		if (!content.contentEquals(read)) {
			File out = new File(
					"src/main/resources/com/neuronrobotics/sdk/addons/kinematics/xml/NASASuspensionTestOUTPUT.xml");
